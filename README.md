...
| Πακέτο | Περιεχόμενο |
|---|---|
| `packages/domain` | Μηχανή κατανομής — καθαρή, χωρίς I/O. Ποσά σε ακέραια λεπτά, BigInt αριθμητική |

```bash
npm install
npm test        # 41 golden tests από το πραγματικό έντυπο
```

Κατάσταση: **σχεδιασμός ολοκληρωμένος · μηχανή κατανομής υλοποιημένη και επαληθευμένη**.
Επόμενο: σχήμα βάσης (Drizzle) και οθόνες.
